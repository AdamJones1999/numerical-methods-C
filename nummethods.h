...
/*
same as rk4 except an extra parameter array 'params' is passed to rk4_single_2() and 
to the function drdt_f to allow for drdt_f to have modified parameters every iteration. 
